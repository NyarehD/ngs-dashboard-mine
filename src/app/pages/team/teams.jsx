                            ...
                            <>
                                <Grid item xs={10}>
                                    <TextField fullWidth value={actionTeamName}
                                               onChange={e => setActionTeamName(e.target.value)}></TextField>
                                </Grid>
                                <Grid item xs={5}>
                            ...
                            <FormControl fullWidth>
                                ...
                                >
                                    {teams.map(team => <MenuItem value={team.teamname} key={team.id}
                                                                 className={teamStyle.teamSelectItem}>{team.teamname}</MenuItem>)}
                                    <Button onClick={_ => AddTeam(false)} fullWidth color='primary'
                                            className={teamStyle.teamSelectItem}>Add Team&nbsp;<FontAwesomeIcon
                                        size="sm" icon={faPlus}/></Button>
                                    <Button onClick={_ => AddTeam(false, true)} fullWidth color='primary'
                                            className={teamStyle.deleteTeam}>Delete Team&nbsp;<FontAwesomeIcon size="sm"
                                                                                                               color="red"
